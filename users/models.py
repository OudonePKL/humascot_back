...
class UserModel(AbstractBaseUser):
    ...
    is_seller = models.BooleanField(default=False, verbose_name="Availability of seller")

    is_active = models.BooleanField(default=True)

    is_admin = models.BooleanField(default=False, verbose_name="Whether there is an administrator or not")
